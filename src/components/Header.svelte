...
<header class={'sticky z-[10] top-0 duration-200 px-6 flex items-cetner justify-between border border-solic' +(
  y > 0 ? 'py-4 bg-slate-950 border-violet-950': 'py-6 bg-transparent border-transparent'
)}>
  <h1 class='font-medium'>
    <b class='font-bold poppins'>Andra</b> Steele
  </h1>
  ...
  target='_blank' 
  class='blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-slate text-white-950'>
